...
# OAuth
GOOGLE_CLIENT_ID=205289341233-5usr7d6tbd5ecq1a7m93jmrujuliq9n9.apps.googleusercontent.com
GOOGLE_CLIENT_SECRET=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
GOOGLE_REDIRECT_URI=http://localhost:3000/dashboard

GITHUB_CLIENT_ID=Ov23li4MLKlUo8znW06j
GITHUB_CLIENT_SECRET=29c77e270c9f1b73860efa4d21bcbc3355fa84f4
GITHUB_REDIRECT_URI=http://localhost:3000/dashboard

# AWS S2
AWS_REGION =ap-south-1
AWS_ACCESS_KEY_ID= AKIASGXBJW622HP2YC6V
AWS_SECRET_ACCESS_KEY=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
AWS_S3_BUCKET_NAME=ctf-platform-storage
AWS_S3_PUBLIC_DOMAIN=https://ctf-platform-storage.s3.ap-south-1.amazonaws.com
